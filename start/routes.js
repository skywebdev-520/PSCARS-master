...
Route.group(() => {
    ...
    Route.get('/orders/:id/contract1', "Admin/OrderController.getContract1").middleware(["auth"])
    Route.get('/orders/:id/agreement', "Admin/OrderController.getAgreement").middleware(["auth"])
    Route.get('/orders/:id/agreement1', "Admin/OrderController.getAgreement1").middleware(["auth"])
